...
cols <- colorRampPalette(c("cornflowerblue", "orange"))(length(oy))
tcx <- 1
tcxa <- 1.4

plot.new()
plot(oy, c(pZ(h(oy))[-ncl], 1), type = "p", axes = FALSE, xlim = c(1, 0),
     ylim = c(0, 1), col = cols, pch = 20, cex = 2)
